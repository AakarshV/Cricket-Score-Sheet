...
int main()
{
      ...
      cout << "Enter the batsman details:" << endl;
      for (int i = 0; i < 3; i++)
      {
            cout << "Enter name of batsman " << i + 1 << endl;
            cin>>pl1[i].name;
            cout << "enter the runs scored by batsman " << i + 1 << endl;
            cin >> pl1[i].runs;
            cout << "Enter the overs played by the batsman " << i + 1 << endl;
            cin >> pl1[i].totove;
      ...
      for (i = 0; i < 3; i++)
      {
            ...
            cin >> pl2[i].wktstkn;
            cout << "Enter the total overs bowled by the  bowler " << i + 1 << endl;
            cin >> pl2[i].ttvrs;
      }
...
abc:
      ...
      case 1:
            cout << "Enter the batsman number to see his details " << endl
                 << endl
                 << endl;
            cin >> plno;
            plno--;
      ...
      case 2:
            cout << "Enter the bowlers number to see his details " << endl
                 << endl
                 << endl;
            cin >> plno;
            plno--;
            cout << "Bowlers name :";
            puts(pl2[plno].name);
            cout << "Runs given by the bowler is :" << pl2[plno].rnsgvn << endl;
            cout << "Total overs played by the bowler :" << pl2[plno].ttvrs << endl;
            cout << "Total wickets taken by the bowler :" << pl2[plno].wktstkn << endl;
            break;

      default:
            cout << "Please enter a decent value" << endl;
            goto abc;
      }
      ...
      cout << endl
           << endl
           << endl
           << "Do you wish to continue? Y-1 N-2" << endl;
      cin >> plno;
      if (plno == 1)
            goto xyz;
      else
